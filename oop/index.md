...
- безопасность типов
- то есть мы не можем знать, какой объект представляет поле, будь то это строка или число, а при попытке получить значение обределенного типа мы столкнемся с ошибкой
